...
//	@AfterThrowing(pointcut = "execution(* by.itac.project02.service.impl.*.*(..))", throwing = "theExc")
//	private void afterThrowingNewsDaoException(JoinPoint joinPoint, Throwable theExc){
//		
//		String method = joinPoint.getSignature().toShortString();
//		log.log(Level.WARN, "=======>> in @AfterThrowing: calling method: " + method);
//		log.log(Level.INFO, "=======>> The exception is: " + theExc);
