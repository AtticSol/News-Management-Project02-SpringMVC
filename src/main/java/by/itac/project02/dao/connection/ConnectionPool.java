package by.itac.project02.dao.connection;
...
public class ConnectionPool {
	...
	private static volatile ConnectionPool instanceCP = null;

	public static ConnectionPool getInstanceCP() throws ConnectionPoolException {
		if (instanceCP == null) {
			instanceCP = new ConnectionPool();
		}
		return instanceCP;
	}
